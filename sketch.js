          ...
          if(gameState===PLAY){
                ...
                if(gunGroup.isTouching(eG)){
                      ...
                      if(eG[0].x<950){
                          ...
                          eG[0].setCollider("rectangle",0,500,eG[0].width,eG[0].height)
                          //eG.remove(eG[0])
...
function spawnEnemy(){
        if(frameCount%200===0){
              ...
              enemy.velocityX=-(2.9 + 3* speed/100)
              enemy.velocityY=5
...
function blackEnemy(){
      if(frameCount%400===0){
            ...
            blackE.velocityX=-(5 + 3* speed/100)
...
function spawnEG(){
      if(frameCount%60===0 && enemy.x<=950){
            ...
            enemyGun.velocityX=-(5 + 3* speed/100)
...
function blackEg(){
        if(frameCount%60===0){
            ...
            blackGun.velocityX=-(6 + 3* speed/100)
